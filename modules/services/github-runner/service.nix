      ...
      map (mkIf cfg.enable) [
        ...
        }
        {
          assertion =
            cfg.workDir == null
            || !(
              hasPrefix "/run/" cfg.workDir || hasPrefix "/var/run/" cfg.workDir || hasPrefix "/private/var/run/"
            );
        ...
        launchd = mkIf cfg.enable {
          text = mkBefore (''
            ...
            (
              ...
              ${getExe' pkgs.coreutils "chmod"} o+rx ${
                escapeShellArg (mkLogDir {
                  name = "";
                })
              }
        ...
        serviceConfig = mkMerge [
          {
            ...
            KeepAlive = {
              Crashed = false;
            } // mkIf cfg.ephemeral { SuccessfulExit = true; };
