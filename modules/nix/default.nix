...

{
  imports =
    ...
    [
      ...
      ] (altOption "nix.daemonProcessType"))
      (mkRemovedOptionModule [
        "nix"
        "daemonIOSchedClass"
      ] (altOption "nix.daemonProcessType"))
      ...
      ] (altOption "nix.daemonIOLowPriority"))
      (mkRemovedOptionModule [
        "nix"
        "readOnlyStore"
      ] "No `nix-darwin` equivalent to this NixOS option.")
      ...
      (mkRemovedOptionModule [
        "nix"
        "profile"
      ] "Use `nix.package` instead.")
      (mkRemovedOptionModule [
        "nix"
        "version"
      ] (consider "nix.package.version"))
      ...
      (mkRemovedOptionModule [
        "nix"
        "daemonNiceLevel"
      ] (consider "nix.daemonProcessType"))
    ]
    ++ mapAttrsToList (
      oldConf: newConf:
      mkRenamedOptionModule
  ...
  config = {
    ...
    assertions =
      ...
      [
        ...
        {
          assertion = elem "_nixbld1" config.users.knownGroups -> elem "_nixbld1" createdUsers;
